...
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(3, 'rua da adoção', 13,'80808416515',2,'FEMININO','Raquel', 'COMPLETED');
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(5, 'rua Z', 14,'15132150',1,'MASCULINO','Rodrigo', 'EMPTY');
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(6, 'rua Y', 9,'218044984',2,'FEMININO','Juliana', 'EMPTY');
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(7, 'rua X', 8,'808984',1,'FEMININO','Leilane', 'EMPTY');
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(8, 'rua X', 8,'808984',3,'FEMININO','Júlia', 'IN_PROGRESS');
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(9, 'rua X', 8,'808984',3,'FEMININO','Laís', 'IN_PROGRESS');
insert into crianca  (id, address, age, civil_id, siblings_id, gender, name, adocao_status)
values(10, 'rua X', 8,'808984',3,'FEMININO','Pedro', 'IN_PROGRESS');
